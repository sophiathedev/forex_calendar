defmodule ForexCalendar.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind forex_calendar", "esbuild forex_calendar"],
      "assets.deploy": [
        "tailwind forex_calendar --minify",
        "esbuild forex_calendar --minify",
        "phx.digest"
      ]
    ]
  end
