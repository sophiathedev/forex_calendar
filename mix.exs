defmodule ForexBot.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind forex_bot", "esbuild forex_bot"],
      "assets.deploy": [
        "tailwind forex_bot --minify",
        "esbuild forex_bot --minify",
        "phx.digest"
      ]
    ]
  end
