defmodule ForexBot.Slash.Announce do
  ...
  def command(_interaction) do
    ...
    today_begin_of_day =
      DateTime.new!(today, ~T[00:00:00], "Asia/Ho_Chi_Minh") |> DateTime.shift_zone!("Etc/UTC")

    today_end_of_day =
      DateTime.new!(today, ~T[23:59:59.999999], "Asia/Ho_Chi_Minh")
  ...
  defp response_action_row(jobs) do
    ...
    selection_menu =
      Nostrum.Struct.Component.SelectMenu.select_menu(
    ...
    [
      content:
        "Vui lòng đối chiếu với các mốc thời gian ở trên, để chọn ra thời gian tin mà muốn thông báo **ngay lập tức**:",
