...
#
#     PHX_SERVER=true bin/forex_calendar start
#
...
if config_env() == :prod do
  ...
  config :forex_calendar, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :forex_calendar, ForexCalendar.Mailer,
